...
#=========function for display on the screen=========================================================================================================================================
    def display(self, value):
        txtDisplay.delete(0,END)
        txtDisplay.insert(0,value)

# function for arithematic operators====================================================================================================================================================
...
#====================function for the operators====================================================================================
    def operation(self,op):
        ...
        self.op = op
        self.result = False
#========== function to clear screen only========================
    def clear_Entry(self):
        self.resut = False
        self.current = "0"
        self.display(0)
        self.input_value = True
#=========== function to clear all entry on the calculator memory====
    def all_clear_Entry(self):
        self.clear_Entry()
        self.total = 0
# creating a function for pi since its a constant
    def pi(self):
        self.result = False
        self.current = math.pi
        self.display(self.current)
# creating a function for 2pi since its a constant      
    def tau(self):
        self.result = False
...
#=========== function for square root=====================================
    def squared(self):
        ...
        self.display(self.current)
#==============function for the cos key======================================
    def cos(self):
        self.result = False
        self.current = math.cos(float(txtDisplay.get()))
        self.display(self.current)
#==============function for the sin key======================================
    def sin(self):
        self.result = False
        self.current = math.sin(float(txtDisplay.get()))
        self.display(self.current)
#==============function for the tan key======================================
    def tan(self):
        self.result = False
        self.current = math.tan(float(txtDisplay.get()))
        self.display(self.current)
#==============function for the sinh key======================================
    def sinh(self):
        self.result = False
        self.current = math.sinh(float(txtDisplay.get()))
        self.display(self.current)
#==============function for the cosh key======================================
    def cosh(self):
        self.result = False
        self.current = math.cosh(float(txtDisplay.get()))
        self.display(self.current)
#==============function for the tanh key======================================
    def tanh(self):
        self.result = False
        self.current = math.tanh(float(txtDisplay.get()))
        self.display(self.current)

 #==============function for the acosh key======================================   
    def acosh(self):
        self.result = False
        self.current = math.acosh(float(txtDisplay.get()))
        self.display(self.current)
#==============function for the asinh key======================================
    def asinh(self):
        self.result = False
        self.current = math.asinh(float(txtDisplay.get()))
        self.display(self.current)
#==============function for the log key======================================
    def log(self):
        self.result = False
        self.current = math.log(float(txtDisplay.get()))
        self.display(self.current)
#==============function for the log10 key======================================
    def log10(self):
        self.result = False
        self.current = math.log10(float(txtDisplay.get()))
        self.display(self.current)
#==============function for the log2 key======================================
    def log2(self):
        self.result = False
        self.current = math.log2(float(txtDisplay.get()))
        self.display(self.current)
#==============function for the degrees key======================================
    def degrees(self):
        self.result = False
        self.current = math.degrees(float(txtDisplay.get()))
        self.display(self.current)
#==============function for the expand key======================================
    def exp(self):
        self.result = False
...
#==============function for the cos key======================================
    def mod(self):
        ...
        self.display(self.current)
#==============function for the log1p key======================================
    def log1p(self):
        self.result = False
        self.current = math.log1p(float(txtDisplay.get()))
        self.display(self.current)
#==============function for the Expm1 key======================================
    def expm1(self):
        self.result = False
        self.current = math.expm1(float(txtDisplay.get()))
        self.display(self.current)
#==============function for the gamma key======================================
    def gamma(self):
        self.result = False
...
btnMod = Button(calc, text = "Mod", width= 6, height = 2, font = ('arial',20,'bold'),bd =4,bg="powder blue",
                command =  added_value.mod).grid(row=3, column = 6, pady = 1)
...
btnlog1p = Button(calc, text = "log1p", width= 5, height = 2, font = ('arial',20,'bold'),bd =4,bg="powder blue",
                  command =  added_value.log1p).grid(row=5, column = 5, pady = 1)

btnEpm1 = Button(calc, text = "expm1", width= 5, height = 2, font = ('arial',20,'bold'),bd =4,bg="powder blue",
...
btn1gamma = Button(calc, text = "1gamma", width= 6, height = 2, font = ('arial',20,'bold'),bd =4,bg="powder blue",
                   command =  added_value.gamma).grid(row=5, column = 7, pady = 1)


iblDisplay = Label(calc, text="Scientific calculator", font = ('arial',30,'bold'), justify = CENTER)
...
#==========================Menu and function==============================
#===== function for the exit operation======================
def iExit():
...
#========== function to switch to standard calculator===================
def Standard():
    root.resizable(width=False, height=False)
    root.geometry("480x560+0+0")
...
### creating the menu bar that is file, edit and help==================
